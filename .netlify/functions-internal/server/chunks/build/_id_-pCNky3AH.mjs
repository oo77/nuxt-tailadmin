...
import { ref, computed, mergeProps, unref, withCtx, createTextVNode, createBlock, openBlock, createVNode, withModifiers, createCommentVNode, Fragment, renderList, toDisplayString, withDirectives, vModelText, vModelSelect, vModelCheckbox, vModelRadio, useSSRContext } from 'vue';
...
import * as cpexcel from '/Users/macbookair/projects/ATC/nuxt-tailadmin/node_modules/xlsx/dist/cpexcel.js';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`</div></div></div><div class="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-7 mb-6"><div class="rounded-lg bg-white dark:bg-boxdark p-5 shadow-md"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div><p class="text-xs font-medium text-gray-600 dark:text-gray-400">Всего вопросов</p><p class="text-xl font-bold text-black dark:text-white">${ssrInterpolate(questions.value.length)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-5 shadow-md"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-full bg-success/10"><svg class="w-5 h-5 text-success" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div><p class="text-xs font-medium text-gray-600 dark:text-gray-400">Лёгких (Easy)</p><p class="text-xl font-bold text-black dark:text-white">${ssrInterpolate(difficultyStats.value.easy)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-5 shadow-md"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-full bg-warning/10"><svg class="w-5 h-5 text-warning" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg></div><div><p class="text-xs font-medium text-gray-600 dark:text-gray-400">Средних (Medium)</p><p class="text-xl font-bold text-black dark:text-white">${ssrInterpolate(difficultyStats.value.medium)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-5 shadow-md"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-full bg-danger/10"><svg class="w-5 h-5 text-danger" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div><p class="text-xs font-medium text-gray-600 dark:text-gray-400">Сложных (Hard)</p><p class="text-xl font-bold text-black dark:text-white">${ssrInterpolate(difficultyStats.value.hard)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-5 shadow-md"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-full bg-blue-100/50 dark:bg-blue-900/30 text-lg"> 🇷🇺 </div><div><p class="text-xs font-medium text-gray-600 dark:text-gray-400">Русский</p><p class="text-xl font-bold text-black dark:text-white">${ssrInterpolate(languageStats.value.ru)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-5 shadow-md"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-full bg-green-100/50 dark:bg-green-900/30 text-lg"> 🇺🇿 </div><div><p class="text-xs font-medium text-gray-600 dark:text-gray-400">O&#39;zbek</p><p class="text-xl font-bold text-black dark:text-white">${ssrInterpolate(languageStats.value.uz)}</p></div></div></div><div class="rounded-lg bg-white dark:bg-boxdark p-5 shadow-md"><div class="flex items-center gap-3"><div class="flex h-10 w-10 items-center justify-center rounded-full bg-purple-100/50 dark:bg-purple-900/30 text-lg"> 🇬🇧 </div><div><p class="text-xs font-medium text-gray-600 dark:text-gray-400">English</p><p class="text-xl font-bold text-black dark:text-white">${ssrInterpolate(languageStats.value.en)}</p></div></div></div></div><div class="bg-white dark:bg-boxdark rounded-xl shadow-md p-6 mb-6"><div class="flex items-center gap-3 mb-4"><div class="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z"></path></svg></div><h4 class="text-lg font-semibold text-black dark:text-white">Фильтры вопросов</h4>`);
        ...
        if (questionsLoading.value) {
          ...
          ssrRenderList(filteredQuestions.value, (question, index) => {
            _push(`<div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"><div class="flex items-start gap-4"><div class="flex-shrink-0 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 text-sm font-medium text-gray-600 dark:text-gray-400">${ssrInterpolate(index + 1)}</div><div class="flex-grow min-w-0"><div class="flex items-start justify-between gap-4"><div class="flex-grow"><p class="text-gray-900 dark:text-white font-medium line-clamp-2">${ssrInterpolate(question.question_text)}</p><div class="flex flex-wrap items-center gap-2 mt-2"><span class="${ssrRenderClass(languageBadgeClasses[question.language || "ru"])}">${ssrInterpolate(languageFlags[question.language || "ru"])} ${ssrInterpolate(languageLabels[question.language || "ru"])}</span><span class="inline-flex items-center rounded-full bg-primary/10 px-2 py-0.5 text-xs font-medium text-primary">${ssrInterpolate(questionTypeLabels[question.question_type])}</span><span class="${ssrRenderClass([
              "inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium",
              difficultyClasses[question.difficulty]
            ])}">${ssrInterpolate(difficultyLabels[question.difficulty])}</span><span class="inline-flex items-center rounded-full bg-gray-100 dark:bg-gray-700 px-2 py-0.5 text-xs font-medium text-gray-600 dark:text-gray-400">${ssrInterpolate(question.points)} ${ssrInterpolate(pluralize(question.points, "балл", "балла", "баллов"))}</span>`);
            if (!question.is_active) {
              _push(`<span class="inline-flex items-center rounded-full bg-gray-100 dark:bg-gray-700 px-2 py-0.5 text-xs font-medium text-gray-500 dark:text-gray-500"> Неактивен </span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
            if (question.question_type === "single" || question.question_type === "multiple") {
              _push(`<div class="mt-3"><div class="flex flex-wrap gap-2"><!--[-->`);
              ssrRenderList(getQuestionOptions(question), (option) => {
                _push(`<span class="${ssrRenderClass([
                  "inline-flex items-center gap-1 rounded-lg px-2 py-1 text-xs",
                  option.correct ? "bg-success/10 text-success border border-success/20" : "bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400"
                ])}">`);
                if (option.correct) {
                  _push(`<svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>`);
                } else {
                  _push(`<!---->`);
                }
                _push(` ${ssrInterpolate(truncateText(option.text, 30))}</span>`);
              });
              _push(`<!--]--></div></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="flex-shrink-0 flex items-center gap-1"><button class="p-2 text-gray-500 hover:text-primary hover:bg-primary/10 rounded-lg transition-colors" title="Редактировать"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg></button>`);
            if (unref(canManageTestBanks)) {
              _push(`<button class="p-2 text-gray-500 hover:text-warning hover:bg-warning/10 rounded-lg transition-colors"${ssrRenderAttr("title", question.is_active ? "Деактивировать" : "Активировать")}>`);
              if (question.is_active) {
      ...
      _push(ssrRenderComponent(_component_UiModal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form class="space-y-5"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Тип вопроса <span class="text-danger"${_scopeId}>*</span></label><div class="grid grid-cols-2 md:grid-cols-5 gap-2"${_scopeId}><!--[-->`);
            ssrRenderList(questionTypes, (type) => {
              _push2(`<button type="button" class="${ssrRenderClass([
                "p-3 rounded-lg border-2 text-center transition-all",
                questionForm.value.question_type === type.value ? "border-primary bg-primary/5 text-primary" : "border-gray-200 dark:border-gray-700 hover:border-primary/50"
              ])}"${ssrIncludeBooleanAttr(type.value !== "single") ? " disabled" : ""}${ssrRenderAttr("title", type.value !== "single" ? "Скоро будет доступно" : "")}${_scopeId}><div class="${ssrRenderClass([{ "opacity-50": type.value !== "single" }, "text-xs font-medium"])}"${_scopeId}>${ssrInterpolate(type.label)}</div></button>`);
            });
            _push2(`<!--]--></div></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Текст вопроса <span class="text-danger"${_scopeId}>*</span></label><textarea rows="3" placeholder="Введите текст вопроса..." class="${ssrRenderClass([{ "border-danger": questionFormErrors.value.question_text }, "w-full rounded-lg border border-stroke bg-transparent py-2 px-4 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary resize-none"])}"${_scopeId}>${ssrInterpolate(questionForm.value.question_text)}</textarea>`);
            if (questionFormErrors.value.question_text) {
              _push2(`<p class="mt-1 text-sm text-danger"${_scopeId}>${ssrInterpolate(questionFormErrors.value.question_text)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            if (questionForm.value.question_type === "single") {
              _push2(`<div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Варианты ответов <span class="text-danger"${_scopeId}>*</span></label><div class="space-y-3"${_scopeId}><!--[-->`);
              ssrRenderList(questionForm.value.options, (option, index) => {
                _push2(`<div class="flex items-center gap-3"${_scopeId}><label class="flex-shrink-0 cursor-pointer"${_scopeId}><input type="radio"${ssrRenderAttr("name", "correct-option-" + editingQuestion.value?.id)}${ssrIncludeBooleanAttr(option.correct) ? " checked" : ""} class="sr-only peer"${_scopeId}><div class="w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all peer-checked:border-success peer-checked:bg-success border-gray-300 dark:border-gray-600"${_scopeId}><svg class="w-4 h-4 text-white hidden peer-checked:block" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"${_scopeId}></path></svg></div></label><span class="flex-shrink-0 w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-sm font-medium text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(String.fromCharCode(65 + index))}</span><input${ssrRenderAttr("value", option.text)} type="text"${ssrRenderAttr("placeholder", `Вариант ${String.fromCharCode(65 + index)}`)} class="${ssrRenderClass([{ "border-success": option.correct }, "flex-grow rounded-lg border border-stroke bg-transparent py-2 px-4 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary"])}"${_scopeId}>`);
                if (questionForm.value.options.length > 2) {
                  _push2(`<button type="button" class="flex-shrink-0 p-2 text-gray-400 hover:text-danger hover:bg-danger/10 rounded-lg transition-colors"${_scopeId}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"${_scopeId}></path></svg></button>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
            ...
            _push2(`<div class="grid grid-cols-1 md:grid-cols-4 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Язык <span class="text-danger"${_scopeId}>*</span></label><div class="relative"${_scopeId}><select class="w-full rounded-lg border border-stroke bg-transparent py-2 pl-4 pr-10 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none"${_scopeId}><option value="ru"${ssrIncludeBooleanAttr(Array.isArray(questionForm.value.language) ? ssrLooseContain(questionForm.value.language, "ru") : ssrLooseEqual(questionForm.value.language, "ru")) ? " selected" : ""}${_scopeId}>🇷🇺 Русский</option><option value="uz"${ssrIncludeBooleanAttr(Array.isArray(questionForm.value.language) ? ssrLooseContain(questionForm.value.language, "uz") : ssrLooseEqual(questionForm.value.language, "uz")) ? " selected" : ""}${_scopeId}>🇺🇿 O&#39;zbek</option><option value="en"${ssrIncludeBooleanAttr(Array.isArray(questionForm.value.language) ? ssrLooseContain(questionForm.value.language, "en") : ssrLooseEqual(questionForm.value.language, "en")) ? " selected" : ""}${_scopeId}>🇬🇧 English</option></select><svg class="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"${_scopeId}></path></svg></div></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Сложность </label><div class="relative"${_scopeId}><select class="w-full rounded-lg border border-stroke bg-transparent py-2 pl-4 pr-10 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary appearance-none"${_scopeId}><option value="easy"${ssrIncludeBooleanAttr(Array.isArray(questionForm.value.difficulty) ? ssrLooseContain(questionForm.value.difficulty, "easy") : ssrLooseEqual(questionForm.value.difficulty, "easy")) ? " selected" : ""}${_scopeId}>Лёгкий</option><option value="medium"${ssrIncludeBooleanAttr(Array.isArray(questionForm.value.difficulty) ? ssrLooseContain(questionForm.value.difficulty, "medium") : ssrLooseEqual(questionForm.value.difficulty, "medium")) ? " selected" : ""}${_scopeId}>Средний</option><option value="hard"${ssrIncludeBooleanAttr(Array.isArray(questionForm.value.difficulty) ? ssrLooseContain(questionForm.value.difficulty, "hard") : ssrLooseEqual(questionForm.value.difficulty, "hard")) ? " selected" : ""}${_scopeId}>Сложный</option></select><svg class="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"${_scopeId}></path></svg></div></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Баллы </label><input${ssrRenderAttr("value", questionForm.value.points)} type="number" min="1" max="100" class="w-full rounded-lg border border-stroke bg-transparent py-2 px-4 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary"${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Статус </label><label class="relative inline-flex items-center cursor-pointer mt-1"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(questionForm.value.is_active) ? ssrLooseContain(questionForm.value.is_active, null) : questionForm.value.is_active) ? " checked" : ""} type="checkbox" class="sr-only peer"${_scopeId}><div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary/25 dark:peer-focus:ring-primary/25 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[&#39;&#39;] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary"${_scopeId}></div><span class="ms-3 text-sm font-medium text-gray-700 dark:text-gray-300"${_scopeId}> Активен </span></label></div></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"${_scopeId}> Объяснение (показывается после ответа) </label><textarea rows="2" placeholder="Почему этот ответ правильный..." class="w-full rounded-lg border border-stroke bg-transparent py-2 px-4 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary resize-none"${_scopeId}>${ssrInterpolate(questionForm.value.explanation)}</textarea></div></form>`);
          } else {
            return [
              createVNode("form", {
                ...
                createVNode("div", null, [
                  createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" }, [
                    createTextVNode(" Тип вопроса "),
                    createVNode("span", { class: "text-danger" }, "*")
                  ]),
                  createVNode("div", { class: "grid grid-cols-2 md:grid-cols-5 gap-2" }, [
                    (openBlock(), createBlock(Fragment, null, renderList(questionTypes, (type) => {
                      return createVNode("button", {
                        key: type.value,
                        type: "button",
                        onClick: ($event) => questionForm.value.question_type = type.value,
                        class: [
                          "p-3 rounded-lg border-2 text-center transition-all",
                          questionForm.value.question_type === type.value ? "border-primary bg-primary/5 text-primary" : "border-gray-200 dark:border-gray-700 hover:border-primary/50"
                        ],
                        ...
                        createVNode("div", {
                          class: ["text-xs font-medium", { "opacity-50": type.value !== "single" }]
                        }, toDisplayString(type.label), 3)
                ...
                createVNode("div", null, [
                  ...
                  withDirectives(createVNode("textarea", {
                    ...
                    class: ["w-full rounded-lg border border-stroke bg-transparent py-2 px-4 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary resize-none", { "border-danger": questionFormErrors.value.question_text }]
                ...
                questionForm.value.question_type === "single" ? (openBlock(), createBlock("div", { key: 0 }, [
                  createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" }, [
                  ...
                  createVNode("div", { class: "space-y-3" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(questionForm.value.options, (option, index) => {
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("label", { class: "flex-shrink-0 cursor-pointer" }, [
                          createVNode("input", {
                            type: "radio",
                          ...
                          createVNode("div", { class: "w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all peer-checked:border-success peer-checked:bg-success border-gray-300 dark:border-gray-600" }, [
                            (openBlock(), createBlock("svg", {
                        ...
                        createVNode("span", { class: "flex-shrink-0 w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-sm font-medium text-gray-600 dark:text-gray-400" }, toDisplayString(String.fromCharCode(65 + index)), 1),
                        withDirectives(createVNode("input", {
                          "onUpdate:modelValue": ($event) => option.text = $event,
                          type: "text",
                          placeholder: `Вариант ${String.fromCharCode(65 + index)}`,
                          class: ["flex-grow rounded-lg border border-stroke bg-transparent py-2 px-4 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary", { "border-success": option.correct }]
                ...
                createVNode("div", { class: "grid grid-cols-1 md:grid-cols-4 gap-4" }, [
                  ...
                  createVNode("div", null, [
                    createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" }, " Сложность "),
                    createVNode("div", { class: "relative" }, [
                      withDirectives(createVNode("select", {
                  ...
                  createVNode("div", null, [
                    createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" }, " Баллы "),
                    withDirectives(createVNode("input", {
                  ...
                  createVNode("div", null, [
                    ...
                    createVNode("label", { class: "relative inline-flex items-center cursor-pointer mt-1" }, [
                      withDirectives(createVNode("input", {
                      ...
                      createVNode("span", { class: "ms-3 text-sm font-medium text-gray-700 dark:text-gray-300" }, " Активен ")
                    ])
                  ])
                ]),
                createVNode("div", null, [
                  createVNode("label", { class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" }, " Объяснение (показывается после ответа) "),
                  withDirectives(createVNode("textarea", {
...
//# sourceMappingURL=_id_-pCNky3AH.mjs.map
