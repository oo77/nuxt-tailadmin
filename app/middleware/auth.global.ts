...
const ROLE_PROTECTED_PAGES: Record<string, UserRole[]> = {
  ...
  '/teachers': [UserRole.ADMIN, UserRole.MANAGER],
  '/students': [UserRole.ADMIN, UserRole.MANAGER, UserRole.TEACHER],
}
 ...
 * 5. Проверяет роли пользователя для страниц с ограничениями
