...
CREATE TABLE IF NOT EXISTS activity_logs (
  ...
  action_type ENUM('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'IMPORT', 'EXPORT') NOT NULL,
  entity_type ENUM('USER', 'STUDENT', 'CERTIFICATE', 'COURSE', 'DISCIPLINE', 'INSTRUCTOR', 'FILE', 'FOLDER', 'SYSTEM') NOT NULL,
